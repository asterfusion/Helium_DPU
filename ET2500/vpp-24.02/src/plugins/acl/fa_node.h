...
#define ACL_INDEX_BD_ID_TABLE_HASH_NUM_BUCKETS (64 * 1024)
#define ACL_INDEX_BD_ID_TABLE_HASH_MEMORY_SIZE (1ULL<<20)

#define ACL_INDEX_PRIORITY_TABLE_HASH_NUM_BUCKETS (64 * 1024)
#define ACL_INDEX_PRIORITY_TABLE_HASH_MEMORY_SIZE (1ULL<<20)
