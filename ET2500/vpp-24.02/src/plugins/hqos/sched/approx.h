...
#ifndef included_hqos_approx_h
#define included_hqos_approx_h
 ...
 */
int hqos_approx(double alpha, double d, uint32_t *p, uint32_t *q);
 ...
 *   0 upon success, error code otherwise
 */
int hqos_approx_64(double alpha, double d, uint64_t *p, uint64_t *q);
