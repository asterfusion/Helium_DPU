...
extern void mgre_update_adj (vnet_main_t * vnm,
			     u32 sw_if_index, adj_index_t ai);
...
adj_walk_rc_t gre_adj_update_walk_cb (adj_index_t ai, void *ctx);
adj_walk_rc_t mgre_adj_update_walk_cb (adj_index_t ai, void *ctx);
...
extern int vnet_gre_tunnel_update_key (u32 sw_if_index, gre_key_t gre_key);
