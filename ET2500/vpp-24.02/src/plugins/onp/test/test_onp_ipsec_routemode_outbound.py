...
class TestIpsecOutboundRouteMode(VppTestCase):
    """TestIpsecOutboundRouteMode Test Case - """ """packet forwarding via IPSEC outbound tunnel"""

    @classmethod
    def setUpConstants(self):
        """Set-up the test case class based on environment variables"""
        self.extra_vpp_plugin_config = ["plugin", "onp_plugin.so", "{", "enable", "}"]
        super(TestIpsecOutboundRouteMode, self).setUpConstants()
    ...
    def setUpClass(self):
        ...
        super(TestIpsecOutboundRouteMode, self).setUpClass()
    ...
    def tearDownClass(cls):
        cls.igw.quit()
        super(TestIpsecOutboundRouteMode, cls).tearDownClass()
    ...
    def setUp(self):
        ...
        super(TestIpsecOutboundRouteMode, self).setUp()
    ...
    def tearDown(self):
        ...
        super(TestIpsecOutboundRouteMode, self).tearDown()
