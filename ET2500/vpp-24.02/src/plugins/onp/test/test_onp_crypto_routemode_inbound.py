...
@unittest.skip("lookaside inbound tests are disabled")
class TestCryptoInboundRouteMode(VppTestCase):
    """TestCryptoInboundRouteMode Test Case - """ """crypto inbound routemode"""

    @classmethod
    def setUpConstants(self):
        """Set-up the test case class based on environment variables"""
        self.extra_vpp_plugin_config = ["plugin", "onp_plugin.so", "{", "enable", "}"]
        super(TestCryptoInboundRouteMode, self).setUpConstants()
    ...
    def setUpClass(self):
        ...
        super(TestCryptoInboundRouteMode, self).setUpClass()
    ...
    def tearDownClass(cls):
        cls.igw.quit()
        super(TestCryptoInboundRouteMode, cls).tearDownClass()
    ...
    def setUp(self):
        ...
        super(TestCryptoInboundRouteMode, self).setUp()
    ...
    def tearDown(self):
        ...
        super(TestCryptoInboundRouteMode, self).tearDown()
    ...
    # aes_gcm
    def test_crypto_inbound_1tunnelsa_ar_on_aes_gcm_128_101B_c1(self):
        self.crypto_algo = "aes-gcm-128"
        self.ipsec_inbound_setup()
        self.ipsec_inbound_run()
        self.ipsec_inbound_validate()

    def test_crypto_inbound_1tunnelsa_ar_on_aes_gcm_192_101B_c1(self):
        self.crypto_algo = "aes-gcm-192"
        self.ipsec_inbound_setup()
        self.ipsec_inbound_run()
        self.ipsec_inbound_validate()

    def test_crypto_inbound_1tunnelsa_ar_on_aes_gcm_256_101B_c1(self):
    ...
    # aes_cbc
    def test_crypto_inbound_1tunnelsa_ar_on_aes_cbc_128_sha_1_101B_c1(self):
    ...
    def test_crypto_inbound_1tunnelsa_ar_on_aes_cbc_192_sha_1_101B_c1(self):
    ...
    def test_crypto_inbound_1tunnelsa_ar_on_aes_cbc_256_sha_1_101B_c1(self):
    ...
    def test_crypto_inbound_1tunnelsa_ar_on_aes_cbc_128_sha_256_101B_c1(self):
        self.crypto_algo = "aes-cbc-128"
    ...
    def test_crypto_inbound_1tunnelsa_ar_on_aes_cbc_192_sha_256_101B_c1(self):
        self.crypto_algo = "aes-cbc-192"
        self.integ_algo = "sha-256-128"
        self.ipsec_inbound_setup()
        self.ipsec_inbound_run()
    ...
    def test_crypto_inbound_1tunnelsa_ar_on_aes_cbc_256_sha_256_101B_c1(self):
        self.crypto_algo = "aes-cbc-256"
        self.integ_algo = "sha-256-128"
        self.ipsec_inbound_setup()
        self.ipsec_inbound_run()
    ...
    def test_crypto_inbound_1tunnelsa_ar_on_aes_cbc_128_sha_384_101B_c1(self):
        self.crypto_algo = "aes-cbc-128"
    ...
    def test_crypto_inbound_1tunnelsa_ar_on_aes_cbc_192_sha_384_101B_c1(self):
        self.crypto_algo = "aes-cbc-192"
        self.integ_algo = "sha-384-192"
        self.ipsec_inbound_setup()
        self.ipsec_inbound_run()
    ...
    def test_crypto_inbound_1tunnelsa_ar_on_aes_cbc_256_sha_384_101B_c1(self):
        self.crypto_algo = "aes-cbc-256"
        self.integ_algo = "sha-384-192"
        self.ipsec_inbound_setup()
        self.ipsec_inbound_run()
    ...
    def test_crypto_inbound_1tunnelsa_ar_on_aes_cbc_128_sha_512_101B_c1(self):
        self.crypto_algo = "aes-cbc-128"
    ...
    def test_crypto_inbound_1tunnelsa_ar_on_aes_cbc_192_sha_512_101B_c1(self):
        self.crypto_algo = "aes-cbc-192"
        self.integ_algo = "sha-512-256"
        self.ipsec_inbound_setup()
        self.ipsec_inbound_run()
    ...
    def test_crypto_inbound_1tunnelsa_ar_on_aes_cbc_256_sha_512_101B_c1(self):
        self.crypto_algo = "aes-cbc-256"
        self.integ_algo = "sha-512-256"
        self.ipsec_inbound_setup()
        self.ipsec_inbound_run()
