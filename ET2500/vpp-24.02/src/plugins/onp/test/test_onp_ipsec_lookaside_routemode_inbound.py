...
class TestIpsecInboundRouteModeLookAside(VppTestCase):
    """TestIpsecInboundRouteModeLookAside Test Case - """ """IPSEC inbound routemode lookaside"""

    @classmethod
    def setUpConstants(self):
        """Set-up the test case class based on environment variables"""
        self.extra_vpp_plugin_config = ["plugin", "onp_plugin.so", "{", "enable", "}"]
        super(TestIpsecInboundRouteModeLookAside, self).setUpConstants()
    ...
    def setUpClass(self):
        ...
        super(TestIpsecInboundRouteModeLookAside, self).setUpClass()
    ...
    def tearDownClass(cls):
        cls.igw.quit()
        super(TestIpsecInboundRouteModeLookAside, cls).tearDownClass()
    ...
    def setUp(self):
        ...
        super(TestIpsecInboundRouteModeLookAside, self).setUp()
    ...
    def tearDown(self):
        ...
        super(TestIpsecInboundRouteModeLookAside, self).tearDown()
