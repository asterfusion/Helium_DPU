...
class TestIpsecOutboundRouteModeLookAside(VppTestCase):
    """TestIpsecOutboundRouteModeLookAside Test Case - """ """IPSEC outbound routemode lookaside"""

    @classmethod
    def setUpConstants(self):
        """Set-up the test case class based on environment variables"""
        self.extra_vpp_plugin_config = ["plugin", "onp_plugin.so", "{", "enable", "}"]
        super(TestIpsecOutboundRouteModeLookAside, self).setUpConstants()
    ...
    def setUpClass(self):
        ...
        otxFw.set_feature(self, otxFw.OtxFeature.LOOKASIDE_IPSEC_MODE)

        super(TestIpsecOutboundRouteModeLookAside, self).setUpClass()
    ...
    def tearDownClass(cls):
        cls.igw.quit()
        super(TestIpsecOutboundRouteModeLookAside, cls).tearDownClass()
    ...
    def setUp(self):
        ...
        super(TestIpsecOutboundRouteModeLookAside, self).setUp()
    ...
    def tearDown(self):
        ...
        super(TestIpsecOutboundRouteModeLookAside, self).tearDown()
    ...
    def verify_onp_stats(self):
        ...
        otx_onp_stats(self)
        self.assertEqual(self.esp4_encrypt_tun_pkts_submit_counters, self.packet_count)
        self.assertEqual(
            self.esp4_encrypt_post_tun_pkts_recv_counters, self.packet_count
        )
        self.assertEqual(self.esp4_encrypt_tun_pkts_counters, self.packet_count)
        self.assertEqual(self.esp4_encrypt_result_fail_counters, 0)
        self.assertEqual(self.esp4_decrypt_frame_recv_counters, 0)
        self.assertEqual(self.esp4_decrypt_pkts_recv_counters, 0)
