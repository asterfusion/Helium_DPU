...
octeon_roc_cmake_args ?=

ifeq ($(PLATFORM), cnxk)
  octeon_roc_cmake_args += -DCMAKE_TOOLCHAIN_FILE=$(_CURDIR)/../../../../src/cmake/cross.cmake
  octeon_roc_cmake_args += -DCMAKE_INSTALL_PREFIX=$(CNXK_SDK_SYSROOT)
else
  octeon_roc_cmake_args += -DCMAKE_INSTALL_PREFIX=$(octeon-roc_install_dir)
endif
...
define  octeon-roc_build_cmds
	@cd ${octeon-roc_src_dir} && rm -f $(octeon-roc_build_log) && $(CMAKE) $(octeon_roc_cmake_args) ${octeon-roc_src_dir} >> $(octeon-roc_build_log)
