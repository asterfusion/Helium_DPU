...
L2_DIRECT_TRAPS = [
    ...
    dict(id=10, name="PTP", make_packet=make_ptp_l2, default_action="trap",
         has_egress=False, is_l2_direct=True),
    dict(id=42, name="ISIS", make_packet=make_isis, default_action="trap",
         has_egress=False, is_l2_direct=True),
...
ARP_TRAPS = [
    dict(id=22, name="ARP_REQUEST", make_packet=make_arp_request,
         default_action="copy", has_egress=False),
    dict(id=23, name="ARP_RESPONSE", make_packet=make_arp_response,
         default_action="copy", has_egress=False),
]
...
IP4_TRAPS = [
    ...
    dict(id=12, name="DHCP_L2", make_packet=make_dhcp_l2,
         default_action="trap", has_egress=True, ingress="l2_phy",
         host="l2_host", egress="l2_egress", exclusive_with=(24,)),
    dict(id=36, name="UNKNOWN_L3_MULTICAST",
...
IP6_TRAPS = [
    ...
    dict(id=30, name="VRRPV6", make_packet=make_vrrpv6,
         default_action="copy", has_egress=True),
    dict(id=31, name="IPV6_NEIGHBOR_DISCOVERY", make_packet=make_nd,
         default_action="copy", has_egress=True),
    dict(id=40, name="IPV6_NEIGHBOR_SOLICITATION", make_packet=make_ns,
         default_action="copy", has_egress=True),
    dict(id=41, name="IPV6_NEIGHBOR_ADVERTISEMENT", make_packet=make_na,
         default_action="copy", has_egress=True),
    dict(id=32, name="IPV6_MLD_V1_V2", make_packet=make_mld_query,
         default_action="trap", has_egress=True, ingress="l2_phy",
         host="l2_host", egress="l2_egress"),
    dict(id=33, name="IPV6_MLD_V1_REPORT", make_packet=make_mld_v1_report,
         default_action="trap", has_egress=True, ingress="l2_phy",
         host="l2_host", egress="l2_egress"),
    dict(id=34, name="IPV6_MLD_V1_DONE", make_packet=make_mld_v1_done,
         default_action="trap", has_egress=True, ingress="l2_phy",
         host="l2_host", egress="l2_egress"),
    ...
    dict(id=13, name="DHCPV6_L2", make_packet=make_dhcpv6_l2,
         default_action="trap", has_egress=True, ingress="l2_phy",
         host="l2_host", egress="l2_egress", exclusive_with=(28,)),
]
...
LOCAL_TRAPS = [
    ...
    dict(id=43, name="IP2ME_V6", make_packet=_local_wrap(make_ip2me_v6),
         default_action="trap", has_egress=False, original_host_count=1),
    dict(id=44, name="SSH", make_packet=_local_wrap(make_ssh),
         default_action="trap", has_egress=False, original_host_count=1),
    dict(id=44, name="SSH_V6", make_packet=_local_wrap(make_ssh_v6),
         default_action="trap", has_egress=False, original_host_count=1),
    dict(id=45, name="SNMP", make_packet=_local_wrap(make_snmp),
         default_action="trap", has_egress=False, original_host_count=1),
    dict(id=45, name="SNMP_V6", make_packet=_local_wrap(make_snmp_v6),
         default_action="trap", has_egress=False, original_host_count=1),
    ...
    dict(id=50, name="BFD_MICRO", make_packet=_local_wrap(make_bfd_micro),
         default_action="trap", has_egress=False, original_host_count=1),
    dict(id=51, name="BFDV6_MICRO", make_packet=_local_wrap(make_bfd_micro_v6),
         default_action="trap", has_egress=False, original_host_count=1),
    dict(id=53, name="GNMI", make_packet=_local_wrap(make_gnmi),
         default_action="trap", has_egress=False, original_host_count=1),
    dict(id=53, name="GNMI_V6", make_packet=_local_wrap(make_gnmi_v6),
         default_action="trap", has_egress=False, original_host_count=1),
    dict(id=54, name="P4RT", make_packet=_local_wrap(make_p4rt),
         default_action="trap", has_egress=False, original_host_count=1),
    dict(id=54, name="P4RT_V6", make_packet=_local_wrap(make_p4rt_v6),
         default_action="trap", has_egress=False, original_host_count=1),
    dict(id=55, name="NTPCLIENT", make_packet=_local_wrap(make_ntp_client),
         default_action="trap", has_egress=False, original_host_count=1),
    dict(id=55, name="NTPCLIENT_V6", make_packet=_local_wrap(make_ntp_client_v6),
         default_action="trap", has_egress=False, original_host_count=1),
    dict(id=56, name="NTPSERVER", make_packet=_local_wrap(make_ntp_server),
         default_action="trap", has_egress=False, original_host_count=1),
    dict(id=56, name="NTPSERVER_V6", make_packet=_local_wrap(make_ntp_server_v6),
         default_action="trap", has_egress=False, original_host_count=1),
    dict(id=57, name="HTTPCLIENT", make_packet=_local_wrap(make_http_client),
         default_action="trap", has_egress=False, original_host_count=1),
    dict(id=57, name="HTTPCLIENT_V6", make_packet=_local_wrap(make_http_client_v6),
         default_action="trap", has_egress=False, original_host_count=1),
    dict(id=58, name="HTTPSERVER", make_packet=_local_wrap(make_http_server),
         default_action="trap", has_egress=False, original_host_count=1),
...
MISC_TRAPS = [
    ...
    _make_misc(62, "N_TYPES", default_action="trap",
