...
class TestLinuxCpCoppArp(LinuxCpCoppTestCase):
    ...
    def test_arp_request_default_copy_suppresses_vpp_reply(self):
        """Default COPY punts the request and lets Linux own the reply."""
        ...
        self.phy.assert_nothing_captured()
