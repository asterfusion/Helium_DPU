#ifndef TREX_DRIVERS_CNXK_H
#define TREX_DRIVERS_CNXK_H
...
class CTRexExtendedDriverBaseCnxk : public CTRexExtendedDriverBase {
public:
    CTRexExtendedDriverBaseCnxk();

    static CTRexExtendedDriverBase * create(){
        return ( new CTRexExtendedDriverBaseCnxk() );
    }
