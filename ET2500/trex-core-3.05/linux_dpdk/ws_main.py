...
dpdk_src_aarch64_cnxk = SrcGroup(dir='src/dpdk/',
            src_list=[
                ...
                'lib/cryptodev/rte_cryptodev.c',
                 ...
                 'drivers/net/cnxk/cnxk_ethdev_cman.c',
                 'drivers/net/cnxk/cnxk_ethdev.c',
                 'drivers/net/cnxk/cnxk_eswitch_rxtx.c',
                 'drivers/net/cnxk/cnxk_eswitch_flow.c',
                 'drivers/net/cnxk/cnxk_eswitch_devargs.c',
                 'drivers/net/cnxk/cnxk_eswitch.c',
                 'drivers/net/cnxk/cn10k_tx_select.c',
    ...
    'drivers/net/cnxk/rx/cn10k/rx_96_111_vec_mseg.c',
      'drivers/net/cnxk/tx/cn10k/tx_0_15.c',
      'drivers/net/cnxk/tx/cn10k/tx_0_15_mseg.c',
      'drivers/net/cnxk/tx/cn10k/tx_0_15_vec.c',
      'drivers/net/cnxk/tx/cn10k/tx_0_15_vec_mseg.c',
      'drivers/net/cnxk/tx/cn10k/tx_112_127.c',
      'drivers/net/cnxk/tx/cn10k/tx_112_127_mseg.c',
      'drivers/net/cnxk/tx/cn10k/tx_112_127_vec.c',
      'drivers/net/cnxk/tx/cn10k/tx_112_127_vec_mseg.c',
      'drivers/net/cnxk/tx/cn10k/tx_16_31.c',
      'drivers/net/cnxk/tx/cn10k/tx_16_31_mseg.c',
      'drivers/net/cnxk/tx/cn10k/tx_16_31_vec.c',
      'drivers/net/cnxk/tx/cn10k/tx_16_31_vec_mseg.c',
      'drivers/net/cnxk/tx/cn10k/tx_32_47.c',
      'drivers/net/cnxk/tx/cn10k/tx_32_47_mseg.c',
      'drivers/net/cnxk/tx/cn10k/tx_32_47_vec.c',
      'drivers/net/cnxk/tx/cn10k/tx_32_47_vec_mseg.c',
      'drivers/net/cnxk/tx/cn10k/tx_48_63.c',
      'drivers/net/cnxk/tx/cn10k/tx_48_63_mseg.c',
      'drivers/net/cnxk/tx/cn10k/tx_48_63_vec.c',
      'drivers/net/cnxk/tx/cn10k/tx_48_63_vec_mseg.c',
      'drivers/net/cnxk/tx/cn10k/tx_64_79.c',
      'drivers/net/cnxk/tx/cn10k/tx_64_79_mseg.c',
      'drivers/net/cnxk/tx/cn10k/tx_64_79_vec.c',
      'drivers/net/cnxk/tx/cn10k/tx_64_79_vec_mseg.c',
      'drivers/net/cnxk/tx/cn10k/tx_80_95.c',
      'drivers/net/cnxk/tx/cn10k/tx_80_95_mseg.c',
      'drivers/net/cnxk/tx/cn10k/tx_80_95_vec.c',
      'drivers/net/cnxk/tx/cn10k/tx_80_95_vec_mseg.c',
      'drivers/net/cnxk/tx/cn10k/tx_96_111.c',
      'drivers/net/cnxk/tx/cn10k/tx_96_111_mseg.c',
      'drivers/net/cnxk/tx/cn10k/tx_96_111_vec.c',
      'drivers/net/cnxk/tx/cn10k/tx_96_111_vec_mseg.c',
'drivers/mempool/cnxk/cnxk_mempool.c',
'drivers/mempool/cnxk/cnxk_mempool_ops.c',
'drivers/mempool/cnxk/cnxk_mempool_telemetry.c',
...
'drivers/mempool/cnxk/cn10k_hwpool_ops.c',
        ...
        'drivers/common/cnxk/roc_eswitch.c',
        ...
        'drivers/crypto/cnxk/cn10k_cryptodev_sec.c',
        ...
        'drivers/event/cnxk/tx/cn10k/tx_0_15.c',
        'drivers/event/cnxk/tx/cn10k/tx_16_31.c',
        'drivers/event/cnxk/tx/cn10k/tx_32_47.c',
        'drivers/event/cnxk/tx/cn10k/tx_48_63.c',
        'drivers/event/cnxk/tx/cn10k/tx_64_79.c',
        'drivers/event/cnxk/tx/cn10k/tx_80_95.c',
        'drivers/event/cnxk/tx/cn10k/tx_96_111.c',
        'drivers/event/cnxk/tx/cn10k/tx_112_127.c',
        'drivers/event/cnxk/tx/cn10k/tx_0_15_seg.c',
        'drivers/event/cnxk/tx/cn10k/tx_16_31_seg.c',
        'drivers/event/cnxk/tx/cn10k/tx_32_47_seg.c',
        'drivers/event/cnxk/tx/cn10k/tx_48_63_seg.c',
        'drivers/event/cnxk/tx/cn10k/tx_64_79_seg.c',
        'drivers/event/cnxk/tx/cn10k/tx_80_95_seg.c',
        'drivers/event/cnxk/tx/cn10k/tx_96_111_seg.c',
        'drivers/event/cnxk/tx/cn10k/tx_112_127_seg.c',

        'lib/eventdev/eventdev_private.c',
        'lib/eventdev/eventdev_trace_points.c',
        'lib/eventdev/rte_event_crypto_adapter.c',
        'lib/eventdev/rte_event_dma_adapter.c',
...
dpdk_includes_path_aarch64 ='''
                        ...
                        ../src/dpdk/drivers/net/cnxk/
                        ../src/dpdk/drivers/common/cnxk/
                        ../src/dpdk/drivers/crypto/cnxk/
                        ../src/dpdk/drivers/mempool/cnxk/
                        ../src/dpdk/drivers/event/cnxk/
                        ../src/dpdk/drivers/dma/cnxk/
                        ../src/dpdk/lib/eventdev/
                        ../src/dpdk/lib/dmadev/
                       '''
...
if march == 'x86_64':
    ...
    DPDK_FLAGS=['-DTAP_MAX_QUEUES=16','-D_GNU_SOURCE', '-DPF_DRIVER', '-DVF_DRIVER', '-DINTEGRATED_VF', '-DRTE_FORCE_INTRINSICS', '-include', '../src/pal/linux_dpdk/dpdk_2403_aarch64/rte_config.h']
elif march == 'ppc64le':
