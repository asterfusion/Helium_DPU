...
:doc:`l2_forward_real_virtual` and :doc:`l2_forward_event_real_virtual`.
...
* ``--eventq-sched:`` Optional, Event queue synchronization method, Ordered or Atomic. Only valid if --mode=eventdev.
...
the initialization and run-time paths are very similar to those of the :doc:`l2_forward_real_virtual` and :doc:`l2_forward_event_real_virtual`.
...
Refer :doc:`l2_forward_event_real_virtual` for more details.
