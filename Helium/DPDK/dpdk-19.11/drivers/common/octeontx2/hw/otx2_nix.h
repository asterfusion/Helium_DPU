...
#define NIX_CGX_RX_PKT_CNT                    (0x0ull)
#define NIX_CGX_RX_OCT_CNT                    (0x1ull)
#define NIX_CGX_RX_PAUSE_PKT_CNT              (0x2ull)
#define NIX_CGX_RX_PAUSE_OCT_CNT              (0x3ull)
#define NIX_CGX_RX_FIFO_DROP_PKT_CNT          (0x6ull)
#define NIX_CGX_RX_FIFO_DROP_OCT_CNT          (0x7ull)
#define NIX_CGX_RX_ERR_CNT                    (0x8ull)

#define NIX_CGX_TX_COLLISION_DROP             (0x0ull)
#define NIX_CGX_TX_MULTIPLE_COLLISION         (0x2ull)
#define NIX_CGX_TX_SINGLE_COLLISION           (0x3ull)
#define NIX_CGX_TX_OCT_CNT                    (0x4ull)
#define NIX_CGX_TX_PKT_CNT                    (0x5ull)
#define NIX_CGX_TX_1_63_PKT_CNT               (0x6ull)
#define NIX_CGX_TX_64_PKT_CNT                 (0x7ull)
#define NIX_CGX_TX_65_127_PKT_CNT             (0x8ull)
#define NIX_CGX_TX_128_255_PKT_CNT            (0x9ull)
#define NIX_CGX_TX_256_511_PKT_CNT            (0xaull)
#define NIX_CGX_TX_512_1023_PKT_CNT           (0xbull)
#define NIX_CGX_TX_1024_1518_PKT_CNT          (0xcull)
#define NIX_CGX_TX_1519_MAX_PKT_CNT           (0xdull)
#define NIX_CGX_TX_BCAST_PKTS                 (0xeull)
#define NIX_CGX_TX_MCAST_PKTS                 (0xfull)
#define NIX_CGX_TX_UFLOW_PKTS                 (0x10ull)
#define NIX_CGX_TX_PAUSE_PKTS                 (0x11ull)
