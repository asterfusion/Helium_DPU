...
static inline int
octeontx_pki_port_close(int port, pki_port_type_t *port_type)
{
	pki_port_type_t ptype = *(pki_port_type_t *)port_type;
...
static inline int
octeontx_pki_port_start(int port, pki_port_type_t *port_type)
{
	pki_port_type_t ptype = *(pki_port_type_t *)port_type;
	int len = sizeof(pki_port_type_t);
	struct octeontx_mbox_hdr hdr;
...
static inline int
octeontx_pki_port_stop(int port, pki_port_type_t *port_type)
{
	pki_port_type_t ptype = *(pki_port_type_t *)port_type;
	int len = sizeof(pki_port_type_t);
	struct octeontx_mbox_hdr hdr;
...
int octeontx_pki_port_open(int port, pki_port_type_t *port_type);
...
int octeontx_pki_port_close(int port, pki_port_type_t *port_type);
...
int octeontx_pki_port_config(int port, pki_prt_cfg_t *prt_cfg);
