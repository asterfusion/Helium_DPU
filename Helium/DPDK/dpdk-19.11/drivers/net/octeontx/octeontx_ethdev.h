...
#define OCTEONTX_VDEV_DEFAULT_MAX_PCI_PORT	32
#define OCTEONTX_VDEV_NR_PORT_ARG		("nr_port")
#define OCTEONTX_VDEV_PCI_PORT_ARG		("pci_port")
#define OCTEONTX_VDEV_SW_PORT_ARG		("dsa_port")
#define OCTEONTX_MAX_NAME_LEN			32

#define OCTEONTX_MAX_BGX_PORTS			5
#define OCTEONTX_MAX_LMAC_PER_BGX		64
...
struct octeontx_nic {
	...
	int port_id;
	int port_type;
	/* Index into kernel port type array table */
	int ptbl_id;
	int port_ena;
	int base_ichan;
	int num_ichans;
