		     ...
		     uint16_t pkts, const uint16_t flags)
{
	...
	while (packets < pkts) {
		...
		ol_flags0 = nix_update_match_id(*(uint16_t *)
				    (cq0 + CQE_SZ(0) + 38), ol_flags0, mbuf0, flags);
        //*(uint16_t *)(cq0 + CQE_SZ(0) + 38) = 0;
		ol_flags1 = nix_update_match_id(*(uint16_t *)
				    (cq0 + CQE_SZ(1) + 38), ol_flags1, mbuf1, flags);
        //*(uint16_t *)(cq0 + CQE_SZ(1) + 38) = 0;
		ol_flags2 = nix_update_match_id(*(uint16_t *)
				    (cq0 + CQE_SZ(2) + 38), ol_flags2, mbuf2, flags);
        //*(uint16_t *)(cq0 + CQE_SZ(2) + 38) = 0;
		ol_flags3 = nix_update_match_id(*(uint16_t *)
				    (cq0 + CQE_SZ(3) + 38), ol_flags3, mbuf3, flags);
        //*(uint16_t *)(cq0 + CQE_SZ(3) + 38) = 0;
