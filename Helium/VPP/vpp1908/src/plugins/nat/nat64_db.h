...
typedef nat64_db_bib_entry_key_t nat64_db_dynamic_no_pat_key_t;
typedef struct
{
 ...
 *
 * @param max_st_per_worker nat64 st max limit.
 * @param db NAT64 DB.
 ...
 */
int nat64_db_init (u32 max_st_per_worker, nat64_db_t * db, u32 bib_buckets, u32 bib_memory_size,
		   u32 st_buckets, u32 st_memory_size,
		   nat64_db_free_addr_port_function_t free_addr_port_cb);

/**
 * @brief submit or update NAT64 ste timer.
 *
 * @param db NAT64 DB.
 * @param st BIB entry.
 */
void nat64_submit_or_update_session_timer(nat64_db_t * db, nat64_db_st_entry_t *ste);


/**
 * @brief delete NAT64 ste timer.
 *
 * @param db NAT64 DB.
 * @param st BIB entry.
 */
void nat64_delete_session_timer(nat64_db_t * db, nat64_db_st_entry_t *ste);
 ...
 */
u32 nat64_db_st_free_walk_expired (u32 thread_index, nat64_db_t * db, u32 now);
 ...
 * @return free expired num
 */
u32 nat64_db_st_free_timer_expired (u32 thread_index, nat64_db_t * db, u32 now);
 ...
 * @param fib_index.
 * @param ste.
 * @param addr_4 nat out ipv4 address.
 * @param port   nat out port number.
 * @param proto L4 protocol.
 *
 */
void nat64_db_dynamic_no_pat_create(u32 fib_index, nat64_db_st_entry_t *ste,
        ip4_address_t * addr_4, u16 port, u8 proto);

/**
 * @brief Free NAT64 no pat .
 *
 * @param bibe BIB entry.
 *
 */
void  nat64_db_dynamic_no_pat_free (nat64_db_bib_entry_t * bibe);
