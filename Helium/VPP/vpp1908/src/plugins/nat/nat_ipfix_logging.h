...
typedef enum {
  ...
  NAT64_BIB_CREATE = 10,
  NAT64_BIB_DELETE = 11,
  NAT46_SESSION_CREATE = 12,
  NAT46_SESSION_DELETE = 13,
  NAT46_BIB_CREATE = 14,
  NAT46_BIB_DELETE = 15,
  NAT_PORTS_EXHAUSTED = 16,
  QUOTA_EXCEEDED = 17,
} nat_event_t;
...
typedef struct {
  ...
  vlib_buffer_t *nat46_bib_buffer;
  vlib_buffer_t *nat46_ses_buffer;
  ...
  vlib_frame_t *nat46_bib_frame;
  vlib_frame_t *nat46_ses_frame;
  ...
  u32 nat46_bib_next_record_offset;
  u32 nat46_ses_next_record_offset;
...
typedef struct {
  ...
  u16 nat46_bib_template_id;
  u16 nat46_ses_template_id;
...
void nat_ipfix_logging_nat64_bib(u32 thread_index,
                                 ...
                                 u16 src_port, u16 nat_src_port,
                                 u32 vrf_id, u8 is_create);
void nat_ipfix_logging_nat46_session(u32 thread_index,
                                     ip4_address_t * src_ip,
                                     ip6_address_t * nat_src_ip, u8 proto,
                                     u16 src_port, u16 nat_src_port,
                                     ip4_address_t * dst_ip,
                                     ip6_address_t * nat_dst_ip,
                                     u16 dst_port, u16 nat_dst_port,
                                     u32 vrf_id, u8 is_create);
void nat_ipfix_logging_nat46_bib(u32 thread_index,
                                 ip4_address_t * src_ip,
                                 ip6_address_t * nat_src_ip, u8 proto,
                                 u16 src_port, u16 nat_src_port,
                                 u32 vrf_id, u8 is_create);
