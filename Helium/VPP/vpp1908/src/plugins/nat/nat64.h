...
typedef struct
{
  ...
  nat64_db_dynamic_no_pat_t dnop;
  ...
  f64 nat64_expire_walk_interval;
...
extern vlib_node_registration_t nat64_expire_worker_walk_node;
 ...
 * @returns 0 on success, non-zero value otherwise.
 */
int nat64_add_interface_address (u32 sw_if_index, int is_add, u8 no_pat, u32 limit_ip_cnt);
...
int nat64_add_del_static_bib_entry (ip6_address_t * in_addr,
				    ...
				    u8 is_add, nat64_static_bib_ctx_t *ctx);
 ...
 */
void nat64_set_hash (u32 max_st_per_worker, u32 bib_buckets, u32 bib_memory_size, u32 st_buckets,
 ...
 * @returns worker thread index.
 */
u32 nat64_get_worker_out2in (ip4_header_t * ip, u32 fib_index);
