...
typedef void (*nat_ha_sadd_cb_t) (ip4_address_t * in_addr, u16 in_port,
				  ...
				  u8 proto, u32 fib_index, u32 pool_index, u16 flags,
				  u32 thread_index);
 ...
 * @param pool_index user addresses pool
...
void nat_ha_sadd (ip4_address_t * in_addr, u16 in_port,
		  ...
		  u32 fib_index, u32 pool_index, u16 flags, u32 thread_index, u8 is_resync);
