 ...
 */
nat_reass_ip6_t *
nat_ip6_reass_find (ip6_address_t src, ip6_address_t dst, u32 frag_id, u8 proto);
 ...
 */
nat_reass_ip6_t *
nat_ip6_reass_create (ip6_address_t src, ip6_address_t dst, u32 frag_id, u8 proto);
/**
 * @brief Find or create reassembly.
 *
 * @param src Source IPv6 address.
